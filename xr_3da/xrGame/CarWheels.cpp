...
void CCar::SWheelDrive::Init()
{
	...
	CBoneData& bone_data= dynamic_cast<CKinematics*>(pwheel->car->Visual())->LL_GetData(u16(pwheel->bone_id));
...
{
	CKinematics* pKinematics=dynamic_cast<CKinematics*>(pwheel->car->Visual());
	pwheel->Init();
